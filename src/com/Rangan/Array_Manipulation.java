...
public class Array_Manipulation {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("1)Swap\t2)Display\t3)Insert\t4)Searching\t5)Sorting\t0)Exit");
            o = sc.nextInt();
                ...
                case 4:
                    ...
                    switch (o) {
                        case 1:
                            ...
                            break;
                        case 2:
                            insertionSort(arr); // sort before binary search
                ...
                case 5:
                    ...
                    System.out.println(
                            "1)Bubble Sort\n" +
                                    "2)Selection Sort\n" +
                                    "3)Insertion Sort\n" +
                                    "4)Cycle Sort (requires numbers from 1..max)\n" +
                                    "5)Merge Sort\n" +
                                    "6)Quick Sort"
                    );
                    o = sc.nextInt();
    ...
    static void insert(ArrayList<Integer> arr, int v) {
        ...
        if (choice == 1) {
            ...
            int i = sc.nextInt();
            if (i < 0 || i > arr.size()) {
                System.out.println("Invalid index, inserting at end instead.");
                arr.add(v);
            } else {
                arr.add(i, v);
            }
    ...
    // Works only when array contains numbers from 1..n (no gaps)
    static void cycleSort(ArrayList<Integer> arr) {
        int i = 0;
        while (i < arr.size()) {
            int correct = arr.get(i) - 1;
            if (correct >= 0 && correct < arr.size() && arr.get(i) != arr.get(correct)) {
                int t = arr.get(i);
